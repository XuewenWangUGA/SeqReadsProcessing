...
Parameters: outfileName in_seqfile.fasta.gz length_cutoff
USAGE: 
Example on testing data:
`python3 filterReadsReportLengthfasta_gz ./testseq.lengths.txt ./testseq.fasta 1000` 
...
usage=""" python3 filterReadsReportLengthfasta_gz.py OUT_seqId_length.txt IN_seq_file_in_fasta.gz length_cutoff
          e.g.: python3 filterReadsReportLengthfasta_gz.py ./testseq.lengths.txt ./testseq.fasta.gz 1000 
          """
#print(usage)
