...
usage=""" python3 filterReadsfastq_gz.py OUT_file_in_fastq.gz IN_seq_file_in_fastq.gz length_cutoff
          e.g.: python3 filterReadsfastq_gz.py ./testseq.filtered.fastq.gz ./testseq.fastq.gz 1000 
          """
print(usage)
